...
use fake::{
    Fake,
    faker::{chrono::en::DateTimeBetween, lorem::en::Sentence, name::en::Name}, Faker,
};
...
use crate::{
    MetadataService,
    pb::{Content, MaterializeRequest, Publisher}, ResponseStream, ServiceResult,
};
...
impl Content {
    pub fn materialize(id: u32) -> Self {
        ...
        Content {
            ...
            views: rng.gen_range(123321..10000000),
